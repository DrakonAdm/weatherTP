...
INSTALLED_APPS = [
    ...
    'weatherTerminator.apps.WeatherterminatorConfig',
    'rest_framework',
...
#     "LEEWAY": 0,
#
#     # JWT должно фигурировать перед токеном
...
AUTH_USER_MODEL = 'weatherTerminator.User'
